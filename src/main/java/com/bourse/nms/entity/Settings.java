...
public class Settings {
    ...
    String tradingLogPath;
    String preOpeningLogPath;
    volatile EngineStatus status = EngineStatus.INITIALIZING;

    public String getPreOpeningLogPath() {
        return preOpeningLogPath;
    }
    ...
    public String getTradingLogPath() {
        return tradingLogPath;
    }

    public void setTradingLogPath(String tradingLogPath) {
        this.tradingLogPath = tradingLogPath;
    }

    public void setPreOpeningLogPath(String preOpeningLogPath) {
        this.preOpeningLogPath = preOpeningLogPath;
    }
