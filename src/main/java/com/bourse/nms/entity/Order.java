...
public class Order implements Comparable {
    ...
    public int compareTo(Object o) {
        ...
        return Long.compare(((Order) o).getOrderCode(), this.getOrderCode());
    }
    ...
    public String toString() {
        return orderCode + "," + subscriberId + "," + totalQuantity + "," + getPrice() + "," +getSubscriberPriority();
    }

    public static void main(String[] args) {
        Order o1 = new Order(10, (byte)1, 100, 2, OrderSide.BUY);
        System.out.println(o1.getSubscriberPriority());
